...
class DepositsControllerTest < ActionController::TestCase
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post :create, deposit: { address: @deposit.address, available_balance: @deposit.available_balance, pending_received: @deposit.pending_received, user_id: @deposit.user_id }
    end
  ...
  test "should update deposit" do
    patch :update, id: @deposit, deposit: { address: @deposit.address, available_balance: @deposit.available_balance, pending_received: @deposit.pending_received, user_id: @deposit.user_id }
    assert_redirected_to deposit_path(assigns(:deposit))
  end
